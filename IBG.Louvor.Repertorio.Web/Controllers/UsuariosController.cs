...
namespace IBG.Louvor.Repertorio.Web.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                Session["usuarios"] = listUsuarios;
                Session["equipes"] = listEquipes;
                ViewBag.Equipes = (List<Equipe>)Session["equipes"];
                var usuarios = (List<Usuario>)Session["usuarios"];
                return View(usuarios.OrderBy(m => m.Nome));
            }
            catch (Exception e)
            {
        ...
        public ActionResult Edit(Usuario usuario)
        {
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    var usuarioAtual = usuarios.FirstOrDefault(u => u.Id == usuario.Id);
